...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'flam3-render.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'flam3-render.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'flam3-render.temp.asm.js';
...
STATICTOP = STATIC_BASE + 240832;
/* global initializers */  __ATINIT__.push();


memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "flam3-render.html.mem" : null;




var STATIC_BUMP = 240832;
...
Module['wasmTableSize'] = 587;

Module['wasmMaxTableSize'] = 587;
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "invoke_vi": invoke_vi, "invoke_iiii": invoke_iiii, "invoke_viiiiiii": invoke_viiiiiii, "invoke_viiiii": invoke_viiiii, "invoke_i": invoke_i, "invoke_iii": invoke_iii, "invoke_vii": invoke_vii, "invoke_iiiiiii": invoke_iiiiiii, "invoke_viiiiiiiii": invoke_viiiiiiiii, "invoke_ii": invoke_ii, "invoke_viii": invoke_viii, "invoke_v": invoke_v, "invoke_iiiii": invoke_iiiii, "invoke_viiiiii": invoke_viiiiii, "invoke_iidid": invoke_iidid, "invoke_iiiiii": invoke_iiiiii, "invoke_viiii": invoke_viiii, "___syscall221": ___syscall221, "_pthread_cond_wait": _pthread_cond_wait, "__inet_pton4_raw": __inet_pton4_raw, "_pthread_join": _pthread_join, "___syscall102": ___syscall102, "_llvm_pow_f64": _llvm_pow_f64, "___syscall168": ___syscall168, "___syscall54": ___syscall54, "__inet_ntop4_raw": __inet_ntop4_raw, "_pthread_attr_destroy": _pthread_attr_destroy, "_pthread_create": _pthread_create, "__inet_pton6_raw": __inet_pton6_raw, "___syscall20": ___syscall20, "__read_sockaddr": __read_sockaddr, "_usleep": _usleep, "_emscripten_get_now_is_monotonic": _emscripten_get_now_is_monotonic, "_pthread_attr_setdetachstate": _pthread_attr_setdetachstate, "___buildEnvironment": ___buildEnvironment, "_longjmp": _longjmp, "_pthread_cond_init": _pthread_cond_init, "_llvm_exp2_f64": _llvm_exp2_f64, "_clock_gettime": _clock_gettime, "_llvm_sqrt_f64": _llvm_sqrt_f64, "___setErrNo": ___setErrNo, "_pthread_key_delete": _pthread_key_delete, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_pthread_attr_init": _pthread_attr_init, "__exit": __exit, "___clock_gettime": ___clock_gettime, "_pthread_getspecific": _pthread_getspecific, "_nanosleep": _nanosleep, "___syscall91": ___syscall91, "_pthread_cond_signal": _pthread_cond_signal, "_pthread_mutex_destroy": _pthread_mutex_destroy, "_pthread_once": _pthread_once, "_abort": _abort, "_getenv": _getenv, "___map_file": ___map_file, "_pthread_key_create": _pthread_key_create, "___unlock": ___unlock, "__write_sockaddr": __write_sockaddr, "__inet_ntop6_raw": __inet_ntop6_raw, "_exit": _exit, "_emscripten_get_now": _emscripten_get_now, "___syscall10": ___syscall10, "_pthread_setspecific": _pthread_setspecific, "_gethostbyname": _gethostbyname, "_sysconf": _sysconf, "___lock": ___lock, "_llvm_exp2_f32": _llvm_exp2_f32, "___syscall6": ___syscall6, "___syscall5": ___syscall5, "___syscall183": ___syscall183, "_getaddrinfo": _getaddrinfo, "_time": _time, "_pthread_cond_destroy": _pthread_cond_destroy, "_emscripten_longjmp": _emscripten_longjmp, "___syscall140": ___syscall140, "_pthread_mutex_init": _pthread_mutex_init, "___syscall142": ___syscall142, "___syscall145": ___syscall145, "___syscall146": ___syscall146, "_pthread_exit": _pthread_exit, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
...
Module['postRun'].push(function() {
  var url = URL.createObjectURL(new Blob([FS.readFile('00001.png')], {type: 'image/png'}));
