...
int main(int argc, char **argv) {
   fprintf(stderr, "Start of main :D\n");
   ...
   int num_threads = argi("nthreads",1);
   ...
   fprintf(stderr,"TESTING WHOOOO!!! %d. \n", verbose);
